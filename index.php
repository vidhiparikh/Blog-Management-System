...
<?php 
			...
			$total_posts_query = mysqli_query($connection, $query);//send this query to this connection.
			...
			while($row = mysqli_fetch_assoc($select_all_posts_query)){
				...
				$post_get_content = $row['post_content'];
				$post_new_content = stripslashes($post_get_content);
				$post_content = substr($post_new_content,0,200)."...";
